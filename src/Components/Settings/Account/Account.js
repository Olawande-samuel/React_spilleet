...
export const Account = () => {
    ...
    useEffect(()=>{
        ...
        if (data) {
            ...
            setName({...name, fullname: user.fullname, usertoken: user.usertoken, phone: user.phone, email:user.email})
        }
    ...
    const handleSubmit =(e)=>{
      ...
      Fetch("https://spilleetapi.spilleet.com/update-profile", formData)
        .then((res) => {
            setLoading(false)
    ...
    return (
        <form>
            ...
            <Divider />
            <Box>
            <Grid container justifyContent="space-between" py={2} alignItems="center">
                <Grid item xs={4} md={6}>
                ...
                <Grid item xs={8} md={6} display="flex"  alignItems="center">
                    ...
                    <p className={Style.linkText} onClick={openModal}>Change profile image</p>
                </Grid>
            </Grid>
            <Divider />
            ...
            <Grid container justifyContent="space-between" py={2} alignItems="center">
                ...
                <Grid item xs={8} md={6} >
                    <p className={Style.textValue}>{name.email} <span className={Style.secondaryText} >Primary Email</span> </p>
            ...
            <Grid container justifyContent="space-between" py={2} alignItems="center">
                ...
                <Grid item xs={8} md={6}>
                    <p className={Style.linkText} onClick={handleLogout}>Logout</p>
                </Grid>
            </Grid>
            <Divider />
            ...
            <Grid container justifyContent="space-between" py={2} alignItems="center">
                ...
                <Grid item xs={8} md={6} display="flex" alignItems="center" gap={2}>
                    <span className={Style.textValue}>Require email verification</span> <span><Toggle /></span>
                </Grid>
            </Grid>
            <Divider />
            ...
            <Box mt={6}>
                ...
                <Grid container justifyContent="space-between" py={2} alignItems="center">
                        <Grid item xs={6} display="flex" alignItems="center" gap={1} >
                           <button className={edited ? Style.btn : Style.disabledBtn} disabled={edited === true ? false: true} onClick={handleSubmit} >Save Changes</button>
                        </Grid>
                        
                    </Grid>
            <EditProfile handleOpen={openModal} handleClose={closeModal} open={toggleOpen} />
            </Box>
        </form>
    )
             }