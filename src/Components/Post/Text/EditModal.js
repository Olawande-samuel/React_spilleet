...
useEffect(()=>{
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      Fetch("https://spilleetapi.spilleet.com/edit-post", formData)
        .then((res) => {
          setLoading(false);
          if (res.data.success === false) {
            setStatus("error");
...
>
          <Box sx={mStyle}> 
          <Typography variant="h5" component="h2" textAlign="center">Edit Post</Typography>
              ...
              {loading ? (
                ...
                <>
                  <Box minHeight="90%" style={style}>
                    ...
                    <Box display="flex" flex="5%" flexDirection="column" mt={2} mb={1} px={matches ? 1 : 4} >
                      <button
                        type="submit"
                        style={{
                          border: "none",
                    ...
                    <Box display="flex" flex="5%" flexDirection="column" mb={2} px={matches ? 1 : 4} >
                      <button
                      onClick={(e)=>{
                        e.preventDefault();
                        handleClose()
